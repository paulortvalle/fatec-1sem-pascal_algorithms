...
Este é o repositório GitHub Pages das aulas do Professor Marcos Nava na FATEC Mogi Mirim durante o primeiro semeste do curso de Análise e Desenvolvimento de Sistemas. 

* As aulas foram ministradas em Pascal.
...
* O objetivo deste repositório NÃO É ensinar a linguagem Pascal, mas tâo somente, exercitar os fundamentos da lógica de programação com algoritimos simplificados.
